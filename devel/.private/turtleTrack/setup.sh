...
<<<<<<< HEAD
: ${_CATKIN_SETUP_DIR:=/usr/users/promo2018/masclet_hug/turtlebot/devel/.private/turtleTrack}
=======
: ${_CATKIN_SETUP_DIR:=/usr/users/promo2017/deferrieresd_hug/turtlebot/devel/.private/turtleTrack}
